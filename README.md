...
Hi, I'm **Joy Murengi**, a Data Analyst who enjoys turning messy data into meaningful insights. Every data has a story waiting to be told. I can do that:). 

This repository showcases my data analytics projects across **Python**, **SQL**, **Power BI**, and **Tableau**. Each project focuses on solving a real-world business problem using data-driven analysis, visualization, and storytelling. Enjoy!
